...
from wfx.io import DataInput, HandleInput, IntInput, MultilineInput, Output
from wfx.schema.data import Data
from wfx.utils.data_structure import get_data_structure
...
class LambdaFilterComponent(Component):
    ...
    documentation: str = "https://docs.aiexec.org/components-processing#smart-transform"
