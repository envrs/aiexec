...
The [Aiexec integrated development environment (IDE) Helm chart](https://github.com/khulnasoft/aiexec/tree/main/charts/aiexec-ide) is designed to provide a complete environment for developers to create, test, and debug their flows. It includes both the Aiexec API and visual editor.
...
You can modify the Aiexec IDE Helm chart's [`values.yaml`](https://github.com/khulnasoft/aiexec/blob/main/charts/aiexec-ide/values.yaml) file to customize your deployment.
