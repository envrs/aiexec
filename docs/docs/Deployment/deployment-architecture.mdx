...
* **Portability**: Kubernetes is a portable platform, which means that you can deploy the Aiexec service to any Kubernetes cluster, on-premises or in the cloud.
    ...
    Aiexec can be deployed on cloud platforms like AWS EKS, Google GKE, or Azure ASK. For more information, see the [Aiexec Helm charts repository](https://github.com/khulnasoft/aiexec).
