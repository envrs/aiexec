...
Aiexec JSON files contain the following:
...
For example Aiexec JSON files, you can examine any of the https://github.com/khulnasoft/aiexec/tree/main/src/backend/base/aiexec/initial_setup/starter_projects[templates in the Aiexec repository], or you can create a flow from a template in Aiexec, export it, and then open the exported JSON file in a text editor.
