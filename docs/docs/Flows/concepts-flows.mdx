...
By default, flows and flow execution data are stored in the Aiexec database, and flow logs are stored with other Aiexec logs in the Aiexec config directory.
