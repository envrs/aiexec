...
For template formatting examples, see [`/starter_projects`](https://github.com/khulnasoft/aiexec/tree/main/src/backend/base/aiexec/initial_setup/starter_projects) in the Aiexec repository.

## Create a PR to submit your template

Follow these steps to submit your template:

1. Fork the [Aiexec repository](https://github.com/khulnasoft/aiexec) on GitHub.
...
Don't use custom components that aren't part of the Aiexec codebase.
...
For more information, see the Aiexec repository's [template categories](https://github.com/khulnasoft/aiexec/blob/main/src/frontend/src/modals/templatesModal/index.tsx#L27-L57).