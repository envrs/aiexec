...
New components are added as objects of the [`Component`](https://github.com/khulnasoft/aiexec/blob/main/src/backend/base/aiexec/custom/custom_component/component.py) class.

Dependencies are added to the [pyproject.toml](https://github.com/khulnasoft/aiexec/blob/main/pyproject.toml#L148) file.
...
2. Write your processor as an object of the [`Component`](https://github.com/khulnasoft/aiexec/blob/main/src/backend/base/aiexec/custom/custom_component/component.py) class. You'll create a new class, `DataFrameProcessor`, that will inherit from `Component` and override the base class's methods.
...
class DataFrameProcessor(Component):
    ...
    documentation: str = "https://aiexec-docs.khulnasoft.com/components-dataframe-processor"
...
You can view the [/data/__init__.py](https://github.com/khulnasoft/aiexec/blob/dev/src/backend/base/aiexec/components/data/__init__.py) in the Aiexec repository.

7. Add any new dependencies to the [pyproject.toml](https://github.com/khulnasoft/aiexec/blob/main/pyproject.toml#L20) file.

8. Submit documentation for your component. For this example component, you would submit documentation to the [Data components page](https://github.com/khulnasoft/aiexec/blob/main/docs/docs/Components/components-data.mdx).
