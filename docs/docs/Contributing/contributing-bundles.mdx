...
If you want to contribute your custom components back to the Aiexec project, you must put them into a bundle.

Follow these steps to add components to <Icon name="Blocks" aria-hidden="true" /> **Bundles** in the Aiexec visual editor.
...
You can view the [components folder](https://github.com/khulnasoft/aiexec/tree/main/src/backend/base/aiexec/components) in the Aiexec repository.
...
For an example of adding multiple components in a bundle, see the [Notion](https://github.com/khulnasoft/aiexec/tree/main/src/backend/base/aiexec/components/Notion) bundle.
...
You can view the [icons folder](https://github.com/khulnasoft/aiexec/tree/main/src/frontend/src/icons) in the Aiexec repository.
...
You can view the [lazyIconImports.ts](https://github.com/khulnasoft/aiexec/blob/main/src/frontend/src/icons/lazyIconImports.ts) in the Aiexec repository.
...
8. To add your bundle to the <Icon name="Blocks" aria-hidden="true" /> **Bundles** menu, edit the [`SIDEBAR_BUNDLES` array](https://github.com/khulnasoft/aiexec/blob/main/src/frontend/src/utils/styleUtils.ts#L231) in `/src/frontend/src/utils/styleUtils.ts`.
