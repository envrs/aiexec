...
Bundles contain custom components that support specific third-party integrations with Aiexec.
You add them to your flows and configure them in the same way as Aiexec's core components.
...
Many bundled components are developed by third-party contributors to the Aiexec codebase.
...
To find documentation for a specific bundled component, browse the Aiexec docs and your provider's documentation.
...
The Aiexec documentation focuses on using bundles within flows.
For that reason, it focuses on the Aiexec-specific configuration steps for bundled components.
...
:::tip
The Aiexec documentation doesn't list all bundles or components in bundles.
For the most accurate and up-to-date list of bundles and components for your version of Aiexec, check <Icon name="Blocks" aria-hidden="true" /> **Bundles** in the visual editor.

If you can't find a component that you used in an earlier version of Aiexec, it may have been removed or marked as a [legacy component](#legacy-bundles).
:::

Aiexec offers generic <Icon name="Component" aria-hidden="true" /> **Core components** in addition to third-party, provider-specific bundles.
...
<!-- Not documented but in Aiexec as of 1.5.11 -->
<!--
* AgentQL
* Confluence
* Firecrawl
