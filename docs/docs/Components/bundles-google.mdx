...
Aiexec integrates with [Google BigQuery](https://cloud.google.com/bigquery) through the **BigQuery** component in the [**Google** bundle](/bundles-google), allowing you to execute SQL queries and retrieve data from your BigQuery datasets.
...
* A [running Aiexec server](/get-started-installation)
...
Aiexec includes multiple components that support Google Search, such as the following:
...
The **Google OAuth Token** component was deprecated in Aiexec 1.4.0.
