...
Embedding model components in Aiexec generate text embeddings using a specified Large Language Model (LLM).

Aiexec includes an **Embedding Model** core component that has built-in support for some LLMs.
