...
:::tip
For more examples of the **Loop** component, try the **Research Translation Loop** template in Aiexec, or see the video tutorial [Mastering the Loop Component & Agentic RAG in Aiexec](https://www.youtube.com/watch?v=9Wx7WODSKTo).
:::
...
The **Run Flow** component runs another Aiexec flow as a subprocess of the current flow.
...
It was deprecated in Aiexec version 1.1.2 and replaced by the [**Run Flow** component](#run-flow).
