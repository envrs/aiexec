...
description: Use CometAPI models in Aiexec to generate text or output a Language Model for downstream Components.
---
...
3. In Aiexec, add the **CometAPI** component to your flow.
