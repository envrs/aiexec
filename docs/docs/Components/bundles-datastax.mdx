...
For more information, see [Use Aiexec agents](/agents).
...
However, Aiexec's **Agent** component includes built-in chat memory that is enabled by default.
...
This component was deprecated in Aiexec version 1.1.2.
