...
Instead, download a fresh installation from the [Aiexec website](https://aiexec.org) when a new version is available.
...
5. Download the Windows installer from the [Aiexec website](https://aiexec.org).
