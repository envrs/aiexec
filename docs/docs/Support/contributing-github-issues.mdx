...
The Aiexec GitHub repository is an integral part of the [Aiexec community](/contributing-community).

In addition to general assistance with Aiexec, the repository is the best place to report bugs and request enhancements to ensure that they are tracked by Aiexec maintainers.

## GitHub issues

The [Issues page in the Aiexec repository](https://github.com/khulnasoft/aiexec/issues) is actively updated with bugs and feature requests.
...
Use the [Aiexec repository's labels](https://github.com/khulnasoft/aiexec/labels) to help filter your search.
:::

## GitHub discussions

If you need help with your code or Aiexec in general, you can visit the [Aiexec GitHub Discussions page](https://github.com/khulnasoft/aiexec/discussions) or reach out through other [Aiexec community](/contributing-community) channels.

The Aiexec team doesn't provide individual support over email, and the team believes that public discussions help more users by virtue of their discoverability.

## Community guidelines and tips

Because the Issues and Discussion pages are public, the Aiexec team asks that you follow these guidelines when submitting questions and issues:

* **Provide as many details as possible**: Simply stating that a feature doesn't work isn't helpful. The Aiexec team needs details in order to recreate and find the issue.
...
* **Retrace your steps**: Explain what happened before the error, what you expected to happen instead of the error, and any recent changes you made, such as upgrading Aiexec or a dependency.
* **Describe your environment**: Include your operating system, Aiexec version, Python version, and any other environment-related details that could have contributed to the issue.
