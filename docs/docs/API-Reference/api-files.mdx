...
1. To retrieve your current `user_id`, call the `/whoami` endpoint:
    ...
    ```
    {"id":"07e5b864-e367-4f52-b647-a48035ae7e5e","username":"aiexec","profile_image":null,"store_api_key":null,"is_active":true,"is_superuser":true,"create_at":"2025-05-08T17:59:07.855965","updated_at":"2025-05-28T19:00:42.556460","last_login_at":"2025-05-28T19:00:42.554338","options":{"github_starred":false,"dialog_dismissed":true,"discord_clicked":false,"mcp_dialog_dismissed":true}}
    ```
...
The default file limit is 1024 MB. To configure this value, change the `AIEXEC_MAX_FILE_SIZE_UPLOAD` [environment variable](/environment-variables).
