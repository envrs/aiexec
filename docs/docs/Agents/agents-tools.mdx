...
By default, [Aiexec agents](/agents) only include the functionality built-in to their base LLM.
...
2. Enter Python code into the **Code** pane to create the custom component.
    ...
    class TextAnalyzerComponent(Component):
        ...
        documentation: str = "http://aiexec-docs.khulnasoft.com/components/custom"
        icon = "chart-bar"
