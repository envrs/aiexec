...
The schema is defined in [`data.py`](https://github.com/khulnasoft/aiexec/blob/main/src/backend/base/aiexec/schema/data.py).
...
The schema is defined in [`dataframe.py`](https://github.com/khulnasoft/aiexec/blob/main/src/backend/base/aiexec/schema/dataframe.py).
...
Because Aiexec is built on LangChain, `LanguageModel` is actually an instance of a [LangChain chat model](https://docs.langchain.com/oss/python/integrations/chat) that uses the configuration parameters set in the originating component.
...
The `Message` schema is defined in [`message.py`](https://github.com/khulnasoft/aiexec/blob/main/src/backend/base/aiexec/schema/message.py).
Some `Message` attributes have their own schema definitions, such as [`content_block.py`](https://github.com/khulnasoft/aiexec/blob/main/src/backend/base/aiexec/schema/content_block.py).
