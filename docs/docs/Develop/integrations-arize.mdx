...
To enable Arize tracing, set the required Arize environment variables in your Aiexec deployment.
Arize begins monitoring and collecting telemetry data from your LLM applications automatically.

:::tip
Instructions for integrating Aiexec and Arize are also available in the Arize documentation:

* [Aiexec tracing with Arize Platform](https://arize.com/docs/ax/integrations/frameworks-and-platforms/aiexec/aiexec-tracing)
* [Aiexec tracing with Arize Phoenix](https://arize.com/docs/phoenix/integrations/aiexec/aiexec-tracing)
:::
...
2. In the root of your Aiexec application, edit your existing Aiexec `.env` file or create a new one.
...
4. Start your Aiexec application with your `.env` file:
...
1. In Aiexec, run a flow that has an LLM-driven component, such as an **Agent** component or any language model component.
...
3. To view metrics for your flows, go to the **LLM Tracing** tab.
    ...
    * The `UUID` trace is the trace of the Aiexec components.
